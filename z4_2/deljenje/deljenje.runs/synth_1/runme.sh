...
HD_PWD='D:/PSDS/z4_2/deljenje/deljenje.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deljenje_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deljenje_top.tcl
